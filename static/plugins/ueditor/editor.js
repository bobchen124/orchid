...
(function () {
    ...
    Editor.prototype = {
        ...
        frankScriptSrc:function(id){
        	var me = this;
        	var th = me.document.getElementById(id);
            var s = document.createElement('script');
            s.setAttribute('type','text/javascript');
            s.setAttribute('src','http://www.uubridge.net/pages/common/js/plugin/jwplayer/jwplayer.js');
            th.appendChild(s);
        },
        frankScriptText:function(pid,id,path,width,height){
        	var me = this;
        	var th = me.document.getElementById(pid);
            var s = me.document.createElement('script');
            s.setAttribute('type','text/javascript');
            s.setAttribute('src','http://www.uubridge.net/pages/common/js/plugin/jwplayer/initjw.js');
            s.setAttribute('path',path);
            s.setAttribute('jwid',id);
    ...
    me.commands["insertvideo"] = {
        execCommand: function (cmd, videoObjs){
            ...
            for(var i=0,vi,len = videoObjs.length;i<len;i++){
                 vi = videoObjs[i];
                 videoPath=vi.url;
                 videoWidth=vi.width || 420;
                 videoHeight=vi.height || 280;
                 videoAlign=vi.align||"none";
                 //html.push(creatInsertStr( vi.url, vi.width || 420,  vi.height || 280, vi.align||"none",false,true));
            }
            if(videoPath!=""){
            	//var strs='<p><div id="mediaplayer_wrapper" style="position: static; width: '+videoWidth+'px; height: '+videoHeight+'px; "><object type="application/x-shockwave-flash" data="http://www.uubridge.net:80/pages/common/js/plugin/jwplayer/Player5.swf" width="100%" height="100%" bgcolor="#000000" id="mediaplayer" name="mediaplayer" tabindex="0"><param name="allowfullscreen" value="true"><param name="allowscriptaccess" value="always"><param name="seamlesstabbing" value="true"><param name="wmode" value="opaque"><param name="flashvars" value="netstreambasepath=http://www.uubridge.net/cn/zh_cn/watch/2464.html&amp;id=mediaplayer&amp;file='+videoPath+'&amp;provider=http&amp;skin=http://www.uubridge.net:80/pages/common/js/plugin/jwplayer/blueratio.zip&amp;controlbar.position=over"></object></div></p>';
            	var num=Math.random()*10000000000000000;
            	var strs='<p><div id="mediaplayer_wrapper'+num+'" style="width: '+videoWidth+'px; height: '+videoHeight+'px; "><p id="jwplayer'+num+'"></p></div></p>';
            	if(videoAlign=="center"){
            		strs='<p><center><div id="mediaplayer_wrapper'+num+'" style="position: static; width: '+videoWidth+'px; height: '+videoHeight+'px; "><p id="jwplayer'+num+'"></p></div></center></p>';
            	}else if(videoAlign=="right"){
            		strs='<p><div style="height:'+(parseInt(videoHeight)+20)+'px;"><div id="mediaplayer_wrapper'+num+'" style="float:right;position: static; width: '+videoWidth+'px; height: '+videoHeight+'px; "><p id="jwplayer'+num+'"></p></div></div></p>';
            	}
                me.execCommand("inserthtml",strs);
                
                me.frankScriptText('mediaplayer_wrapper'+num,'jwplayer'+num,videoPath,videoWidth,videoHeight);
            }
