...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            ['Bold', 'Italic', 'Underline', 'ForeColor', 'BackColor', 'FontFamily', 'FontSize', 'InsertUnorderedList', 'InsertOrderedList', 'RemoveFormat']
        ]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{
            'bold':'加粗','italic':'斜体','underline':'下划线','forecolor':'文字颜色','backcolor':'背景颜色','fontfamily':'字体类型','fontsize':'字体大小','insertunorderedlist':'插入无序列表','insertorderedlist':'插入有序列表','removeformat':'清除格式'
        }
        ...
        //,minFrameHeight:_minFrameHeight  // 最小高度,默认320
...
//             'upper-roman' : ''      //'I,II,III...'        
		...
		//insertimage
		//图片上传配置区
        //,imageUrl:URL+"jsp/imageUp.jsp?lang=zh_cn&location=cn&path="+path          //图片上传提交地址
		...
		//fontfamily
        //字体
        ,'fontfamily': [{ label:'',name:'songti',val:'宋体,SimSun'}, { label:'',name:'kaiti',val:'楷体,楷体_GB2312, SimKai'}, { label:'',name:'lishu',val:'隶书, SimLi'}, { label:'',name:'heiti',val:'黑体, SimHei'}, { label:'',name:'arial',val:'arial, helvetica,sans-serif'}, { label:'',name:'timesNewRoman',val:'times new roman'}]
        
		//fontsize
        //字号
        ,'fontsize': ['10', '12', '14', '18', '24', '36']
         
        //attachment
		//附件上传配置区
        //,fileUrl:URL+"jsp/fileUp.jsp?lang=zh_cn&location=cn&path="+path              //附件上传提交地址
